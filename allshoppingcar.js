Vue.component('products', {
  ...
  "<button @click='addToCart(product)'>加入購物車</button><br><br></div>" +
  "</div>" +
  ...
  "<button @click='modalAddToCart(modalData), hideModal()'>加入購物車</button>" +
  "</div></div>",
...
Vue.component('cart', {
  ...
  '<button class="clearCart" v-show="checkoutBool" @click="clearCart()"> 取消</button>' +
  '<button class="checkoutCart" v-show="checkoutBool" @click="propagateCheckout()"> 結帳 </button>',
    ...
    productsData: [
      {
        sku: 1,
        product: "鳳梨",
        image: "https://img.shoplineapp.com/media/image_clips/60a75b39cdd676002ce9c496/original.jpg?1621580601",
        description: "夏天必備酸甜又多汁的鳳梨來了!",
        details: "日清商行最受歡迎的鳳梨來了!你還在等甚麼?趕快下訂吧!",
        price: 40
      },

      {
        sku: 2,
        product: "柚子",
        image: "https://imgcdn.cna.com.tw/www/WebPhotos/800/20231001/1024x768_wmky_0_C20231001000113.jpg",
        description: "又到了中秋節了!!柚子訂了嗎?",
        details: "中秋節時家家戶戶收到怕的柚子來了,還沒想好中秋禮盒送甚麼的,送柚子就對了!",
        price: 23
      },

      {
        sku: 3,
        product: "奇異果",
        image: "https://i.epochtimes.com/assets/uploads/2018/05/kiwi-600x400.jpg",
        description: "來自紐西蘭的奇異果,世界第一的黃金奇異果現正熱銷中!",
        details: "甚麼!?你還沒吃過世界第一好吃的奇異果嗎?快來,現在就在日清商行,等你喔~",
        price: 859
      },

      {
        sku: 4,
        product: "木瓜",
        image: "https://shoplineimg.com/61efa511d8ebda00312cdc21/626ab46a53835f002d4a5c30/800x.jpg?",
        description: "富含維他命木瓜鹼等營養成分的木瓜,現在特別從產地直送",
        details: "當日鮮採產地直送,保證口感Q嫩香甜美味,並且顆顆蔬果套保護出貨",
        price: 66
      },

      {
        sku: 5,
        product: "蘋果",
        image: "https://i.epochtimes.com/assets/uploads/2019/12/Fotolia_84273812_Subscription_L.jpg",
        description: "來自日本的蘋果,現在正是產季,又香又甜的蘋果",
        details: "外型渾圓飽滿，色澤亮麗紅潤,而且清脆可口又多汁！",
        price: 15
      },

      {
        sku: 6,
        product: "橘子",
        image: "https://shop.gwsm.gov.tw/images/thumbs/0059443_550.jpeg",
        description: "來自中國的砂糖橘,甜度高又富含維生素c",
        details: "酸酸甜甜精緻好滋味，溫室培養出的中國砂糖橘，你不可錯過的選擇",
        price: 150
      },

      {
        sku: 7,
        product: "桃子",
        image: "https://d3h1lg3ksw6i6b.cloudfront.net/media/image/2019/07/20/5a6edbb94e1142879eec534803a1239d_%E7%99%BD%E6%A1%83_%E7%9B%B8%E7%89%87%E4%BE%86%E6%BA%90Oisix.jpg",
        description: "來自加州的空運抵台水蜜桃!",
        details: "採用加州知名外銷品牌,多層且快速的品質把關,新鮮桃毛看的到",
        price: 100
      },

      {
        sku: 8,
        product: "芒果",
        image: "https://images.agriharvest.tw/wp-content/uploads/2021/07/126683246_xl-1.jpg",
        description: "來自玉井的愛文芒果，酸甜的滋味與多汁細膩的果肉讓人回味無窮",
        details: "愛文芒果皮紅肉黃口感Q，芒果香味別具特色，撲鼻的芒果香，口感香甜細嫩。",
        price: 170
      },

      {
        sku: 9,
        product: "西瓜",
        image: "https://i.epochtimes.com/assets/uploads/2022/06/id13761918-shutterstock_1422071948-600x400.jpg",
        description: "有機甜美人西瓜,消暑又止渴!",
        details: "甜度較高，果肉細緻且口感爽脆，為即將到來的炎炎夏日，消暑解渴。",
        price: 99
      },

      {
        sku: 10,
        product: "芭樂",
        image: "https://images.agriharvest.tw/wp-content/uploads/2023/04/7304-9-1-0.jpg",
        description: "產地直送的有機轉型期白肉土芭樂",
        details: "由土芭樂原生種選育， 近40年的土芭樂果樹，成熟的果實具獨特濃郁的香氣 、果肉細緻、柔軟，一口咬下，充滿果香味~",
        price: 68
      }
    ],
    checkoutBool: false,
